<template>
    ...
    <div class="row">
        ...
        <div class="col-4 p-0 me-1">
            <h2 class="text-success">DANH SÁCH SÁCH</h2>
            <BookList :books="books" :bookIndex="bookIndex" @show:book="getShowBook"/>
        </div>
        <div class="col rounded p-2 mx-5" v-if="bookIndex >= 0" style="background: #C9E4D6;">
            ...
            <div v-if="filteredBooks.soQuyen > 0">
                ...
                <form @submit.prevent="RentBook(filteredBooks)" style="width: 60%;"
                    class="border rounded border-2 p-2 border-success mt-2 mx-auto" v-if="showRentBook">
