<template>
    <Form class="row border border-2 border-success rounded px-3 pb-3 col-8" @submit="submitBook" :validation-schema="contactFormSchema" style="background: #FFF0F5">
        <div class="col">
    ...
    <div class="col ms-4 border border-2 border-success rounded " style="background: #FFF0F5">
                <h2 class="text-success">Nhà xuất bản</h2>
