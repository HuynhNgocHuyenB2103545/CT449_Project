<template>
    ...
    <Form v-else @submit="register" :validation-schema="userFormSchema" style="max-width: 75%; margin: 20px auto; background: #FFF0F5;" class="p-3 border rounded border-success">
        <div class="text-center my-2 fs-3 pb-2 text-success fw-bold">ĐĂNG KÝ</div>
        ...
        <div>
            <button type="submit" class="col btn btn-outline-success ms-4 py-2">Đăng ký</button>
